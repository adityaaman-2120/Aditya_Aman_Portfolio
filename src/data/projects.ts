export const projects = [
  {
    title: "CivicFix",
    description: "AI-powered platform for civic issue reporting and resolution using computer vision and natural language processing.",
  ...
  {
    title: "InVo",
    description: "Offline-first inventory and POS management mobile app for small shops, enabling product tracking, sales recording, supplier management, weekly reports, and AI-powered business insights.",
  ...
  {
    title: "UnityCure",
    description: "Healthcare assistant using machine learning for symptom analysis and preliminary diagnosis suggestions.",
  ...
  },
  {
    ...
    description: "A Python-based desktop application for managing academic records, automating result computation, and visualizing student performance through analytics and interactive charts.",
